...
//
//    public static VarastoIF getInstance() {
//        if (instanssi == null) {
...
//    }
    ...
    /* (non-Javadoc)
	 * @see ohtu.verkkokauppa.VarastoIF#haeTuote(int)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ohtu.verkkokauppa.VarastoIF#saldo(int)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ohtu.verkkokauppa.VarastoIF#otaVarastosta(ohtu.verkkokauppa.Tuote)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ohtu.verkkokauppa.VarastoIF#palautaVarastoon(ohtu.verkkokauppa.Tuote)
	 */
    @Override
